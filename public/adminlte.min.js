...
!function(e, t) {
    ...
    var n = a(t),
        ...
        f = function() {
            function e(e, t) {
                if (this._element = e, this._parent = e.parents(".card").first(), this._settings = n.default.extend({}, d, t), this._overlay = n.default(this._settings.overlayTemplate), e.hasClass(s) && (this._parent = e), "" === this._settings.source)
            ...
            return t.load = function() {
                ...
                a || (a = new e(n.default(this), i), n.default(this).data(o, "string" == typeof t ? a : t)),
        ...
        M = function() {
            ...
            return t.collapse = function() {
                ...
                var t = n.default("body"),
                    a = n.default("html");
                e && n.default(k).hide(),
                this._config.controlsidebarSlide ? (a.addClass(E), n.default(this._config.target).show().delay(10).queue((function() {
                ...
                if (e.hasClass(R)) {
                    ...
                    if (0 === o && 0 === i)
                        ...
                        o <= a.header ? !1 === l ? (t.css("top", a.header - o), r.css("height", a.window - (a.header - o))) : t.css("top", a.header) : !1 === l ? (t.css("top", 0), r.css("height", a.window)) : t.css("top", a.header);
        ...
        Qe = function() {
            ...
            return t.onTabClick = function(e) {
                ...
                if ("all" == e)
                    ...
                    if (i.remove(), n.default("#" + s).remove(), n.default(be).children().length == n.default(ye + ", " + Ce).length)
                        n.default(ye).show();
                    else {
                        var r = l - 1;
                    ...
                    var d = n.default(ve + ".active"),
                        f = d.parent(),
                        u = d.index();
                    if (d.remove(), n.default(we + ".active").remove(), n.default(be).children().length == n.default(ye + ", " + Ce).length)
                        n.default(ye).show();
                    else {
                        var c = u - 1;
        ...
        Ct = function() {
            ...
            return t.open = function() {
                ...
                return this.each((function() {
                    ...
                    if (a || (a = new e(this, i), n.default(this).data(pt, a)), !/toggle|close|open/.test(t))
