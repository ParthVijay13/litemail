...
!function(t, e) {
    if ("object" == typeof exports && "object" == typeof module)
        module.exports = e(require("/Users/akshanshnagar/Library/Caches/typescript/5.4/node_modules/@types/jquery/index"));
    else if ("function" == typeof define && define.amd)
        define(["jQuery"], e);
    else {
        var n = "object" == typeof exports ? e(require("/Users/akshanshnagar/Library/Caches/typescript/5.4/node_modules/@types/jquery/index")) : e(t.jQuery);
        for (var o in n)
        ...
        return (() => {
            ...
            function et(t, e) {
                ...
                if (0 === t.offset) {
                    ...
                    tt(t.node) ? o = O(n = t.node.childNodes[t.offset - 1]) : (n = t.node, o = e ? 0 : t.offset - 1);
                return {
                    node: n,
                    offset: o
                }
            ...
            function nt(t, e) {
                ...
                if (O(t.node) === t.offset) {
                    ...
                    tt(t.node) ? (n = t.node.childNodes[t.offset], o = 0) : (n = t.node, o = e ? O(t.node) : t.offset + 1);
                return {
                    node: n,
                    offset: o
                }
            ...
            var pt = function() {
                ...
                return n = t, o = [{
                    ...
                    value: function(t) {
                        ...
                        e.shouldInitialize() && (e.initialize && e.initialize(), e.events && ht.attachEvents(this.$note, e.events))
                    }
                }, {
                    key: "module",
                    ...
                    value: function(t) {
                        var e = this.modules[t];
                        e.shouldInitialize() && (e.events && ht.detachEvents(this.$note, e.events), e.destroy && e.destroy()),
            ...
            function vt(t, e) {
                ...
                for (n = 0; n < a.length; n++)
                    if (!ht.isText(a[n])) {
                        if (r.moveToElementText(a[n]), r.compareEndPoints("StartToStart", t) >= 0)
                            break;
                        o = a[n]
                    }
                if (0 !== n && ht.isText(a[n - 1])) {
                    ...
                    for (var u = c.text.replace(/[\r\n]/g, "").length; u > l.nodeValue.length && l.nextSibling;)
                        ...
                        l = l.nextSibling;
                    l.nodeValue;
                    e && l.nextSibling && ht.isText(l.nextSibling) && u === l.nodeValue.length && (u -= l.nodeValue.length, l = l.nextSibling),
                    i = l,
                    n = u
                }
                return {
                ...
                var e = document.body.createTextRange(),
                    n = function t(e, n) {
                        ...
                        if (ht.isText(e)) {
                            ...
                            if (o = e.childNodes[n] || e, ht.isText(o))
                                return t(o, 0);
                            n = 0,
                            i = !1
                        }
                ...
                return n = t, o = [{
                    ...
                    value: function() {
                        if (ht.isBodyContainer(this.sc) && ht.isEmpty(this.sc))
                            return this.sc.innerHTML = ht.emptyPara, new t(this.sc.firstChild, 0, this.sc.firstChild, 0);
                        var e,
                            n = this.normalize();
            ...
            var Ft = function() {
                ...
                return n = t, o = [{
                    ...
                    value: function() {
                        ...
                        })) : (this.options.width && this.$editor.outerWidth(this.options.width), this.options.height && this.$editable.outerHeight(this.options.height), this.options.maxHeight && this.$editable.css("max-height", this.options.maxHeight), this.options.minHeight && this.$editable.css("min-height", this.options.minHeight)),
                ...
                return n = t, o = [{
                    ...
                    value: function() {
                        ...
                        this.$dropzone.on("drop", (function(n) {
                            ...
                            n.preventDefault(),
                            o && o.files && o.files.length ? (t.$editable.focus(), t.context.invoke("editor.insertImagesOrCallback", o.files)) : e().each(o.types, (function(n, i) {
            ...
            var qt = function() {
                ...
                return n = t, (o = [{
                    ...
                    value: function() {
                        ...
                        t ? (this.$editable.data("orgHeight", this.$editable.css("height")), this.$editable.data("orgMaxHeight", this.$editable.css("maxHeight")), this.$editable.css("maxHeight", ""), this.$window.on("resize", this.onResize).trigger("resize")) : (this.$window.off("resize", this.onResize), this.resizeTo({
                    ...
                    value: function() {
                        if (this.lastWord) {
                            ...
                            this.options.match(e, (function(e) {
                                if (e) {
                                    var n = "";
                                    if ("string" == typeof e ? n = ht.createText(e) : e instanceof jQuery ? n = e[0] : e instanceof Node && (n = e), !n)
                                        return;
                ...
                function t(n) {
                    ...
                    this.events = {
                        ...
                        "summernote.keyup summernote.mouseup summernote.scroll": function(t, e) {
                            o.options.editing && !o.onContextmenu && (o.pageX = e.pageX, o.pageY = e.pageY, o.update()),
                            o.onContextmenu = !1
                        },
